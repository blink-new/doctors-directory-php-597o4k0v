<div class="category-page">
    <div class="container">
        <div class="breadcrumb">
            ...
            <span class="breadcrumb-current"><?php echo htmlspecialchars($region_info['address']); ?> Həkimləri</span>
        </div>
        
        <div class="page-header">
            <h1 class="page-title"><?php echo htmlspecialchars($region_info['address']); ?> Həkimləri</h1>
            <p class="page-description">
                <?php echo htmlspecialchars($region_info['address']); ?> bölgəsində ən yaxşı həkimləri tapın. 
                Təcrübəli həkimlərimizlə əlaqə saxlayın.
            </p>
            
            <div class="results-count">
                <span class="count-number"><?php echo count($region_doctors); ?></span> həkim tapıldı
            </div>
        </div>
        
        <?php if (count($region_doctors) > 0): ?>
        <div class="doctors-list">
            <?php foreach ($region_doctors as $doctor): ?>
        ...
        <div class="no-results">
            ...
            <p class="no-results-text">Bu bölgədə həkim mövcud deyil. Digər bölgələrə baxın.</p>
